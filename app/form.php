...
$add = '';
$add .= strpos($ushit,'http://') !== false ? '' : 'http://';
$add .= $ushit;
$ushit = $add;
#-- Detecting store name
$checkstore = parse_url($ushit);
...
$sql1 = "SELECT ptitle FROM pdata WHERE ptitle='$_title3' AND storeName='$store' AND userID='$ass'";
...
VALUES ('$ass','$ushit', '$price3', '$price3', '$acton', '$_title3', '$image3', '$store', 'N')";
$conn->query($sql);
